...
func OfferingsNoSupportsAccordionOfferCell(noSupportsAccordionOfferCell ) OfferingsOption {
	return OfferingsOption{func(opts *offeringsOptionImpl) {
		opts.has_noSupportsAccordionOfferCell = true
		opts.noSupportsAccordionOfferCell = noSupportsAccordionOfferCell
	}, fmt.Sprintf("api.OfferingsNoSupportsAccordionOfferCell( %+v)}", noSupportsAccordionOfferCell)}
}
func OfferingsNoSupportsAccordionOfferCellFlag(noSupportsAccordionOfferCell *) OfferingsOption {
	return OfferingsOption{func(opts *offeringsOptionImpl) {
...
has_token bool
		...
		func (o *offeringsOptionImpl) DestinationLatitudeE6() int {  return or.Int(o.destinationLatitudeE6, 40756160) }
	func (o *offeringsOptionImpl) HasDestinationLatitudeE6() bool { return o.has_destinationLatitudeE6 }
		func (o *offeringsOptionImpl) DestinationLongitudeE6() int {  return or.Int(o.destinationLongitudeE6, -73971610) }
	func (o *offeringsOptionImpl) HasDestinationLongitudeE6() bool { return o.has_destinationLongitudeE6 }
		func (o *offeringsOptionImpl) LastOffersID() string {  return or.String(o.lastOffersID, "9ceeb6ef-7023-44ea-9821-acb063780607") }
	func (o *offeringsOptionImpl) HasLastOffersID() bool { return o.has_lastOffersID }
	func (o *offeringsOptionImpl) NoSupportsAccordionOfferCell()  { return o.noSupportsAccordionOfferCell }
	func (o *offeringsOptionImpl) HasNoSupportsAccordionOfferCell() bool { return o.has_noSupportsAccordionOfferCell }
	...
	func (o *offeringsOptionImpl) NoSupportsSelectableOfferCell() bool { return o.noSupportsSelectableOfferCell }
	func (o *offeringsOptionImpl) HasNoSupportsSelectableOfferCell() bool { return o.has_noSupportsSelectableOfferCell }
		func (o *offeringsOptionImpl) OfferSelectorSessionID() string {  return or.String(o.offerSelectorSessionID, "45825ecc-6344-45fc-a433-3dafcbcb8665") }
	...
	type  OfferingsParams struct {
		...
		NoSupportsAccordionOfferCell  `json:"no_supports_accordion_offer_cell"`
